...
abstract class Keys {
  ...
  /// It is packed into a single element list in order to not break the spread syntax.
  static final List<int> arrowUp = Platform.isWindows ? [winUp] : [27, 91, 65];
...
abstract class XTerm {
  ...
  /// Bold output.
  static String bold(Object? str) => '\u001b[1m$str$reset';

  /// Gray color.
  static String gray(Object? str) => '\u001b[38;5;246m$str$reset';

  /// Green color.
  static String green(Object? str) => '\u001b[32m$str$reset';
  ...
  static String teal(Object? str) => '\u001b[38;5;6m$str$reset';
}
